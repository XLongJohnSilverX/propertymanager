...
Delete
    ...
    <p v-if="property.address">{{property.address.streetAddress}} {{property.address.city}}, {{ property.address.state }} {{ property.address.zipCode }}</p>
